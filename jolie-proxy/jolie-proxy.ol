...
service JolieProxy {
    ...
    define initializeHSQLDBConnection {
        ...
        scope ( createTable ) {
            install ( SQLException => println@Console("Books table already there")() );
            updateRequest =
                "CREATE TABLE books (
        ...
        scope ( insertIntoTable) {
            install ( SQLException => println@Console("Books already inserted")() );
            updateRequest =
                "INSERT INTO books (title, ISBN, user_id) VALUES (" + 
                "'Le Petit Prince', '978-2-266-11111-1', '1', " +
                "'Le Seigneur des Anneaux', '978-2-266-11111-2', '2', " +
                "'Harry Potter', '978-2-266-11111-3', '3', " +
                "'Les Misérables', '978-2-266-11111-4', '4', " +
                "'Les Trois Mousquetaires', '978-2-266-11111-5', '5', " +
                "'Les Fleurs du Mal', '978-2-266-11111-6', '6', " +
                "'Les Contemplations', '978-2-266-11111-7', '7');";
            update@Database( updateRequest )( ret )
        }       
    }
    ...
    main {       
        ...
        [ alert(request)() {
            println@Console("🔔 Alerte reçue : " + request.alerts[0].status + ":"+ request.alerts[0].labels.alertname)();
